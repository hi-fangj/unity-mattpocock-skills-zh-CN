...
在 summary 中包含一个 "suggested skills" section，写明下一个 agent 应调用 Skill tool 运行哪些 skills。

不要重复其它 artifacts（specs、plans、ADRs、issues、commits、diffs）中已经记录的内容，改为用 path 或 URL 引用它们。
