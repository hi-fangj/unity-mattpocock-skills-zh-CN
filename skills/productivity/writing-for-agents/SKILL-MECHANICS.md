...
[`writing-for-agents`](SKILL.md) 的 skill-specific 分支：当文档是 skill 时什么会变——frontmatter、invocation 选择和 router skills。其他关于写作的内容，都是 `SKILL.md` 里的 universal reference。
